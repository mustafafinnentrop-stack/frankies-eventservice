...
.cinematic-footer-wrapper a:hover {
...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Getränkeservice</span> <span className="text-primary/60">✦</span>
    <span>Thekenservice</span> <span className="text-secondary/60">✦</span>
    <span>Mobile Cocktailbar</span> <span className="text-primary/60">✦</span>
    <span>Schützenfeste</span> <span className="text-secondary/60">✦</span>
    <span>Hochzeiten</span> <span className="text-primary/60">✦</span>
  </div>
);
