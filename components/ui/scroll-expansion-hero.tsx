...
// das ist dasselbe Paket unter seinem neuen Namen, gleiche API, gleicher
// Code. 'framer-motion' zusaetzlich zu installieren haette die Bibliothek
// ein zweites Mal ins Bundle gelegt. Sonst ist die Datei unveraendert.
