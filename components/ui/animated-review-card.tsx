...
// Vorlage importiert aus "framer-motion". Das Projekt hat bereits "motion" v13 —
// das ist dieselbe Bibliothek unter ihrem heutigen Namen, "motion/react" ist die
// identische React-API. framer-motion zusaetzlich zu installieren wuerde eine
// zweite Kopie derselben Animations-Laufzeit ins Bundle legen.
...
export const AnimatedReviewCards = ({
  ...
  useEffect(() => {
    ...
    // Vorlage nutzt hier @ts-expect-error. In der TS-Version dieses Projekts
    // ist addListener bereits typisiert, die Direktive waere damit selbst ein
    // Fehler ("unused directive") und der Build bricht ab. @ts-ignore hat
    // dieselbe Absicht und funktioniert in beiden Faellen. Nur der Kommentar
    // wurde getauscht, der Code darunter ist unveraendert.
