...
const eventTypes = [
  ...
  { node: <span style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontFamily: 'var(--font-body)', fontSize: '0.8rem', fontWeight: 500, letterSpacing: '0.15em', textTransform: 'uppercase' as const, color: 'var(--color-text-muted)', whiteSpace: 'nowrap' as const }}><span style={{ color: 'var(--color-gold)' }}>✦</span> Bambustheke</span> },
]
