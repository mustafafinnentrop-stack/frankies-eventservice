...
export default function Footer() {
  ...
  return (
    <>
      <footer>
        <div className="footer-inner" style={{ flexDirection: 'column', gap: '2rem', alignItems: 'center', textAlign: 'center' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem 1.5rem', width: '100%', justifyContent: 'center' }}>
