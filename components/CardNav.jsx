...
const ArrowIcon = () => (
  <svg className="nav-card-link-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
    <path d="M5.5 3.5h7v7h-1.5V6.06L4.28 13 3.22 11.94 10.16 5H5.5V3.5z"/>
  </svg>
);
