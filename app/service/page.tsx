  ...
  const portfolioItems = [
    {
      ...
      description: 'Erfahrene Servicekräfte, Barkeeper und Event-Manager für professionelle Abläufe',
      icon: '👥',
    },
    {
      category: 'Getränkeservice',
      description: 'Bier vom Fass, Weine, Cocktails und alkoholfreie Getränke mit professioneller Zapfanlage',
      icon: '🍺',
    },
    {
      category: 'Mobile Cocktailbar',
      description: 'Elegante mobile Cocktailbar mit Bambus-Teke für gehobene Events',
      icon: '🍸',
    },
    {
      category: 'Hüpfburgen & Spielgeräte',
      description: 'Hochwertige Hüpfburgen und Spielgeräte für Kinder und Familien',
      icon: '🎪',
    },
    {
      category: 'Eventmöbel & Ausstattung',
      description: 'Stehtische, Bistrotische, Bestuhlung und stilvolle Raumausstattung',
      icon: '🪑',
    },
    {
      category: 'Fun-Food Module',
      description: 'Slush-Eis, Popcornmaschinen, Candy Bar und weitere kulinarische Highlights',
      icon: '🍿',
    },
    {
      category: 'Fotoboxen & Foto-Mirror',
      description: 'Moderne Fotoboxen und interaktive Foto-Mirror für unvergessliche Erinnerungen',
      icon: '📸',
    },
    {
      category: 'Licht- & Tontechnik',
      description: 'Professionelle Beleuchtung, DJ-Equipment, Showtechnik und Soundanlagen',
      icon: '🎤',
    },
  ]
        ...
        <main style={{ background: 'var(--color-bg)', minHeight: '100vh' }}>
            ...
            <div className="section-container" style={{ maxWidth: '1100px', margin: '0 auto' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                {packages.map((pkg, idx) => (
                  ...
                  >
                    <h3 style={{ fontSize: '1.5rem', marginBottom: '0.5rem', color: 'var(--color-gold)', fontFamily: 'var(--font-display)' }}>
                      {pkg.title}
                    </h3>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: '1.5rem', borderTop: '1px solid rgba(212, 175, 55, 0.1)' }}>
                      <span style={{ fontSize: '1.3rem', color: 'var(--color-gold)', fontWeight: 'bold' }}>
                        {pkg.price}
                      </span>
                      <a
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                {portfolioItems.map((item, idx) => (
                  ...
                  >
                    ...
                    <h3 style={{ fontSize: '1.2rem', marginBottom: '0.75rem', color: 'var(--color-gold)', fontFamily: 'var(--font-display)' }}>
                      {item.category}
                    </h3>
          ...
          <section style={{ padding: '6rem 2rem', background: 'linear-gradient(135deg, rgba(212, 175, 55, 0.1) 0%, rgba(212, 175, 55, 0.05) 100%)' }}>
            <div className="section-container" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
              <h2 style={{ fontSize: '2rem', marginBottom: '1.5rem', color: 'var(--color-text)', fontFamily: 'var(--font-display)' }}>
